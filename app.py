...
import certifi
ca = certifi.where()
client = MongoClient('mongodb+srv://test:sparta@cluster0.xig8tvq.mongodb.net/?retryWrites=true&w=majority', tlsCAFile=ca)
db = client.project
...
def goMain():
    ...
    try:
        ...
        return render_template('main.html', userid=user_info["id"])
...
def api_register():
    ...
    mbtiname_receive = request.form['mbtiname_give']

    pw_hash = hashlib.sha256(pw_receive.encode('utf-8')).hexdigest()

    db.user.insert_one({'id': id_receive, 'pw': pw_hash, 'mbti': mbtiname_receive})
